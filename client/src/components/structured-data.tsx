...
const structuredDataMap: Record<string, object> = {
  calculator: {
    ...
    "url": "https://toolsuitpro.com/calculator",
  ...
  currency: {
    ...
    "url": "https://toolsuitpro.com/currency",
  ...
  units: {
    ...
    "url": "https://toolsuitpro.com/units",
    "applicationCategory": "UtilitiesApplication",
    "operatingSystem": "Any",
    "softwareVersion": "1.0",
    "author": {
  ...
  level: {
    ...
    "url": "https://toolsuitpro.com/level",
    "applicationCategory": "UtilitiesApplication",
    "operatingSystem": "Any",
    "softwareVersion": "1.0",
    "author": {
